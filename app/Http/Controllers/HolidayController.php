      ...
      if(!empty($email))
      {
               ...
               $data['Roledata'] = DB::table('registration')      
                 ->where('status','=','active')    
                  ->where('email','=',$email) 
                  ->first();
					$data['holiday_type']=DB::table('holiday_type')->where('emid','=',$data['Roledata']->reg )->get();
						$data['holiday_rs']=DB::Table('holiday')->where('holiday.emid','=',$data['Roledata']->reg )->select('holiday_type.name','holiday.*')->join('holiday_type','holiday.holiday_type','=','holiday_type.id')->get();
...
$email = Session::get('emp_email');
		$Roledata = DB::table('registration')      
                 ...
                 ->where('status','=','active')    
                  ...
                  ->first();
        ;
			$data['holiday_type']=DB::table('holiday_type')->where('emid','=',$Roledata->reg )->get();
	    // dd($data);
	...
	public function viewHolidayDetails()
	{
	     try{   if(!empty(Session::get('emp_email')))
      {
		...
		$data['holiday_rs']=DB::Table('holiday')->where('holiday.emid','=',$Roledata->reg )->select('holiday_type.name','holiday.*')->join('holiday_type','holiday.holiday_type','=','holiday_type.id')->get();
		// dd($data['holiday_rs']);
...
$email = Session::get('emp_email');
	...
	{ try{
	       if(!empty(Session::get('emp_email')))
      {
		...
		$data['holiday_rs']=DB::Table('holiday_type')->where('emid','=',$Roledata->reg )->select('*')->get();
		// dd($data['holiday_rs']);
