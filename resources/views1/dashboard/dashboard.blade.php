...
.numb h5{color: #fff;font-size: 28px;}.view-more a img{width: 22px;padding-top: 19px;}.numb{text-align: right;}.view-more{text-align: right;}.dash-cont {
    min-height: 61px;}
    .visa-head{
background: linear-gradient(-45deg, #06418e, #1572e8) !important;color: #fff;padding: 8px 15px;border-radius: 5px;}
...
?>						<img src="{{ asset('assets/img/login.png')}}"></a>
										 ...
										 <div class="col-xl-4 col-lg-4 col-md-6">
									  <div class="dash-box " style="background: #a19f9f;">
									    <div class="row">
										  <div class="col-md-8 col-8">
										    <div class="dash-ico">
											  <img src="{{ asset('assets/img/search.png')}}" alt="">
									 ...
									 <div class="col-xl-4 col-lg-4 col-md-6">
									  <div class="dash-box sky">
									    <div class="row">
										  <div class="col-md-8 col-8">
										    <div class="dash-ico">
											  <img src="https://workpermitcloud.co.uk/hrms/img/payroll.png" alt="">
											</div>
											 <div class="dash-cont">
											   <h4>Payroll
</h4>
