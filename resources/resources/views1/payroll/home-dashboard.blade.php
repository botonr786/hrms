                            ...
                            <div class="row">
                               <div class="col-md-4 col-4 pr0">
                                  <div class="hcm-icon green">
                                     <img class="" src="{{ asset('public/theme/images/leave-application-icon.png') }}" alt=""style="max-width:120px;">
                                  </div>
                               </div>
                               <div class="col-md-8 col-8 pl0">
                                  <div class="hcm-name green">
                                     <p>Payroll</p>
                                     <a href="{{ url('payroll/dashboard') }}"><img class="" src="{{ asset('public/theme/images/arrow.png') }}" alt=""></a>
                                  </div>
                               </div>
                            </div>
                         </div>
                         ...
                         <div class="hcm" style="margin: 40px 30px 40px 0;">
                            <div class="row">
                               ...
                               <div class="col-md-8 col-8 pl0">
                                  <div class="hcm-name green">
                                     <p>Loans</p>
                                     <a href="{{ url('loans/view-loans') }}"><img class="" src="{{ asset('public/theme/images/arrow.png') }}" alt=""></a>
                                  </div>
                               </div>
                            </div>
                         </div>
                         ...
                         <div class="hcm" style="margin: 40px 30px 40px 0;">
                            <div class="row">
                               ...
                               <div class="col-md-8 col-8 pl0">
                                  <div class="hcm-name green">
                                     <p>Income Tax</p>
                                     <a href="{{ url('itax/dashboard') }}"><img class="" src="{{ asset('public/theme/images/arrow.png') }}" alt=""></a>
                                  </div>
                               </div>
                            </div>
                         </div>
