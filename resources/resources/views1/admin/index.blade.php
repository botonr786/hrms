    ...
    <div class="form-body-admin">
				...
				<!-- <div class="text-center col-lg-8 col-md-6">
					...
					<div class="login-form">
						<div class="col-md-12">
						  <h3><img  style="width: 150px;" src="{{ asset('img/logo.png')}}"> CLIMBR</h3>
						  <h4 style="font-size:18px;margin-top: 30px;color: #388de4;font-weight: 400;border-bottom: 1px solid #999"> Super Admin Login</h4>
...
@endif
				...
				<div id="recaptcha-error" style="color:red;">
							...
							<div class="col-md-12">
								<button class="btn btn-default" type="submit" style="width: 100%;color:#fff;background: #277fbe !important;">LOGIN</button>
