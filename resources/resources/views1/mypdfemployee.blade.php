 ...
 <thead>
  <tr>
    <th style="text-align: left;width: 10%;">
        @if($Roledata->logo!='null')  <img src="https://workpermitcloud.co.uk/hrms/public/{{ $Roledata->logo }}" alt="" width="130"/>@endif 
...
<table style="width:100%;margin-top: 50px;">
    <tr>
<td colspan="2" style="text-align:right;border-radius:50%;">
          ...
          @else
         <img src="https://workpermitcloud.co.uk/hrms/public/assets/img/user.png" style="height:100px;width:100px;border-radius:50%;"/> 
          
          @endif</td>
</tr>
<tr>
<td>Employee Code:{{ $employeedata->emp_code }}</td>

<td style="text-align:right">Employee Name: {{  $employeedata->emp_fname}} {{  $employeedata->emp_mname}} {{  $employeedata->emp_lname}}	</td>
</tr>
<tr>
<td class="mm">Department:{{  $employeedata->emp_department}}</td>

<td style="text-align:right" class="mm">Designation: {{  $employeedata->emp_designation}}	</td>
</tr>
</table>
