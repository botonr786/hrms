			...
			<div class="content">
				<div class="page-inner">
					...
					<div class="form-group">
												...
												@if($Roledata->logo!='')
																<a href="{{ asset($Roledata->logo) }}" target="_blank">	<img src="{{ asset($Roledata->logo) }}" height="50px" width="50px"/ ></a>
																	@endif
