			                     ...
			                     {{csrf_field()}}
									...
									<div class="row">
										 ...
										 <input type="hidden" name="detailsId" value="<?php print_r($rate['0']->id)?>" >
											<label for="inputFloatingLabel" class="placeholder">Head Type(*)</label>
												<select class="form-control" name="pay_type" id="headType" onchange="headtypeFunc()">
                                                    ...
                                                    <option value="<?php print_r($rate['0']->pay_type) ?>"
                                                     <?php if($rate['0']->pay_type==="DEDUCATION") {?> selected="selected" <?php }else if($rate['0']->pay_type==="EARNING") {?> selected="selected" <?php } ?> ><?php print_r($rate['0']->pay_type) ?></option>
                                        ...
                                        <div class="col-md-3">
										    ...
										    <option value="<?php print_r($rate['0']->rate_id) ?>"><?php print_r($rate['0']->headname) ?></option>
								            </select>
                                    ...
                                    <select class="form-control" name="cal_type" id="cal_type" onchange="checkcaltype(this.value);" required>
                                        ...
                                        <option value="<?php print_r($rate['0']->cal_type)?>">
                                            <?php if($rate['0']->cal_type=="F") {?>FIXED <?php } ?>
                                            <?php if($rate['0']->cal_type=="V") {?>VARIABLE <?php } ?> 
                                        </option>
