									...
									<div class="row">
										...
										<div class="form-group">
											<label for="inputFloatingLabel" class="placeholder">idcaste_master</label>
												<input id="inputFloatingLabel" type="number" class="form-control input-border-bottom"  name="idcaste_master" value="<?php print_r($cast['0']->idcaste_master) ?>" readonly/>
										</div>
										</div>
										<div class="col-md-4">
										<div class="form-group">
											<label for="inputFloatingLabel" class="placeholder">Caste Name</label>
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom"  name="caste_name" value="<?php print_r($cast['0']->caste_name) ?>" />
										</div>
	</div>
	<div class="col-md-4">
										<div class="form-group">
