			...
			<div class="content">
			 ...
			 {{csrf_field()}}
									<div class="row">
										...
										<div class="form-group">
											<label for="inputFloatingLabel" class="placeholder">Sub Caste Name</label>
												<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom"  name="sub_cast" />
										</div>
										<div class="form-group">
