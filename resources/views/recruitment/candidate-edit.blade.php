  ...
  @include('recruitment.include.header')
	    ...
	    // }
		 ...
		 <input type="date" name="application_date" id="application_date" value="{{date('Y-m-d',strtotime($job->date))}}" class="form-control">	
										...
										<?php  if($job->apply==''){?>	   <option value="">Online</option> <?php } ?>
										  ...
										  <div class="col-md-4" style="margin-top:35px;">
										    <button class="btn btn-default download" type="button" style=""><a href="{{asset('public/'.$job->resume)}}" download>Download Resume</a></button>
										   </div>
