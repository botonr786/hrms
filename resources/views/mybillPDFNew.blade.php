            ...
            <thead>
                <tr>
                    <th style="text-align: left;">
                        <h3 style="font-size: 25px;">Climbr</h3>
                    </th>
                    <th style="text-align: right;">
                        <h3 style="font-size: 18px;padding-right: 38px;">Pro Forma Invoice</h3>
                    </th>
                </tr>
                <tr>
                    <th style="text-align: left;">2nd Floor, 112-116, Whitechapel Road, London, E1 1JE
                        <br>+44-020-8087-2343<br>
                        info@climbr.co.in<br>
                        www.climbr.co.in<br>
                        VAT Registration# 3843391960
                    </th>

                    <th style="text-align: right;"><img
                            src="https://climbr.co.in/public/assets/img/logo.png"></th>
                </tr>
            </thead>
        </table>
...
?>
                    ...
                    <td style="text-align: right; float: right;">
                        <p style="margin-bottom: 0;"><span style="font-weight: 600;">Pro Forma Invoice. no.:</span> {{$in_id}}</p>
...
?>
        ...
        <table class="main-table" border="1" width="100%"
            style="border:2px solid #000;font-family:calibri;margin: auto;border-collapse: collapse;">
    ...
    for ($i = 0; $i < count($package); $i++) {
        ...
        ?>
                <tr>
                    ...
                    @if($vatc!=0)
                    <td style="text-align: right;">£ <?php if ($inv_discount != 0) {$newval = $discount_amount[$i];} else { $newval = $anount_ex_vat[$i];}

        echo ($net_amount[$i] - $newval);?></td>
        @endif
...
?>
                ...
                <tr style="background-color: transparent;border: none;">
                    <td @if($vatc!=0) colspan="5" @else colspan="4" @endif
                        style="border-left: none;border-bottom: none;border-right: 1px solid #000;border-top: none;">
                    </td>
                    <td style="border-bottom: 1px solid #000;" @if($disc!=0) colspan="2" @else colspan="1" @endif>Total
                        Excluding VAT</td>
                ...
                <tr style="background-color: transparent;border: none;">
                    ...
                    <td style="background: #dbe5f1;border-bottom: 1px solid #000;" @if($disc!=0) colspan="2" @else
                        colspan="1" @endif>VAT (GB VAT {{$vatnew}}%)</td>

                    <td
                        style="text-align: right;background: #dbe5f1;border-bottom: 1px solid #000;border-right: 1px solid #000;">
                        &pound; {{($amount-$vatexclu)}}</td>
                </tr>
                @endif
                <tr style="background-color: transparent;border: none;">
                    <td @if($vatc!=0) colspan="5" @else colspan="4" @endif
...
?>
        <table width="100%" style="font-family: calibri;margin: 25px auto;">
            <tr>
                <td style="text-align: left;"><b>Amount in words: GBP. <?=ucwords(trim($result . $points));?> Only. </b></td>
            </tr>
        </table>
        ...
        <table width="100%" style="font-family: calibri;margin: 25px auto;text-align: left;border-collapse:collapse;">
            <tfoot style="position: fixed;bottom: 0;">
                <tr>
                    ...
                    <td>
                        <p style="margin-bottom: 0;">Climbr is Regulated to provide HRMS Services by the</p>
                ...
                <tr>
                    ...
                    <td colspan=2>
                        <p style="margin-bottom: 0;text-align:center">"This is not a Tax Invoice."</p>
