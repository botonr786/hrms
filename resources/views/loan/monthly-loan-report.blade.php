...
<div class="main-panel">
   <div class="page-header">
      ...
      <ul class="breadcrumbs">
         ...
         <li class="nav-item"><a href="{{url('loan/dashboard')}}">Loan</a></li>
         <li class="separator"> / </li>
         <li class="nav-item active">Monthly Loan Report</li>
      </ul>
   </div>
   <div class="content">
                  ...
                  <div class="card-body">
                    <form action="{{url('loans/vw-loan-report')}}" method="post" enctype="multipart/form-data" style="width:98%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-2">
                                <br>
                                <button type="submit" class="btn btn-info" style="color: #fff;background-color: #0884af;border-color: #0884af;padding: 0px 8px;height: 32px;margin-top:10px;">Go</button>
                            </div>
                        </div>
                    </form>
                  </div>
