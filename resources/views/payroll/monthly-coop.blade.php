									...
									<tfoot>
										...
										<tr>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<button type="submit" name="btnDelete" class="btn btn-info btn-sm" style="background-color:red;float:right;" onclick="confirmDelete(event);">Delete All Records for the month</button>
												</div>
											</div>
											</td>
