        ...
        <tbody>
            ...
            @foreach($bonas as $ratedtl)
                                    <tr>
    									...
    									<td><a href='{{url("settings/employee-update-get/$ratedtl->id")}}' data-toggle="tooltip"data-placement="bottom" title="Edit"><img  style="width: 19px;" src="{{ asset('assets/img/edit.png')}}"></a></td>
                                    </tr>
                                     @endforeach
